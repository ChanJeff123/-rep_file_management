...
if __name__ == "__main__":
    ...
    q='IC 018. US 001 002 003 022 041. G & S: Alpenstocks; Baby carrier covers specially adapted for baby carriers worn on the body; Backpacks for pets; Business card holders in the nature of wallets, card cases; Clothing for pets; Handbags, purses and wallets; Leather credit card cases; Leather credit card holder; Leather credit card wallets; Pouches of textile; Reins for guiding children; Travel bags; Trunks being luggage; Umbrellas and parasols; Backpacks, book bags, sports bags, bum bags, wallets and handbags. FIRST USE: 20190115. FIRST USE IN COMMERCE: 20190115'
    print(trans.en2ch(q))
